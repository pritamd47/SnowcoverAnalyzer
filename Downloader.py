...
def main():
    ...
    addr = 'http://e4ftl01.cr.usgs.gov/MOLT/MOD11A2.006/'  # This is the address of ftp://n5eil01u.ecs.nsidc.org/SAN/MOST/MOD10A2.006. Retrieved from Filezilla
    user = 'pritamd47'
    password = 'BoeinG787'
    filename = "h26v06"
    ftp = ftplib.FTP(addr)
    ...
    response = ftp.cwd("MOLT/MOD11A2.006/")
    ...
    threadhandler(directories[:52], 10, filename, "MOLT/MOD11A2.006/", "temp\\", thread_cap= 5)
